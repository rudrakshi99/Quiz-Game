...
int main()
{
	int countr; // count for challenge round
	int count;	// count for warmup round
	int r, r1, i, n;
	float score;
	char choice; // choices of Main menu
	char playername[20];
mainhome: // Main menu
	system("cls");
	printf("\t\t\t   QUIZ GAME\n");
	...
	else if (choice == 'S')
	{
		...
		printf("\n    total of 10 questions. Each question carry 100 marks");
	...
	score: // Display the total score of player
		system("cls");
...
void help()
{
	...
	printf("\n    total 10 questions.Each question carry 100 marks.");
	printf("\n >> You will be given 4 options and you have to press A, B ,C or D for the");
	printf("\n    right option");
	...
	printf("\n\n\t*********************BEST OF LUCK*********************************");
	printf("\n\n\t*****C PROGRAM QUIZ GAME is developed by RUDRAKSHI********");
}
// Edit Score
